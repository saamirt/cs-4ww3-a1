					...
					<div class="card-body">
						...
						<form>
							...
							<div class="form-group">
								...
								<!-- text type input -->
								<input type="text" pattern="^ *[^ ].*" class="form-control" id="pokestop-name-input"
									placeholder="PokeStop Name" value="" required>
							</div>
							<div class="form-row">
								<div class="col-md-6 mb-3">
									<label for="latitude-input">Latitude</label>
									<!-- text type input -->
									<input type="text" pattern="^-?\d+(.\d+)?$" class="form-control" id="latitude-input"
										placeholder="Latitude" value="" required>
								</div>
								<div class="col-md-6 mb-3">
									<label for="longitude-input">Longitude</label>
									<!-- text type input -->
									<input type="text" pattern="^-?\d+(.\d+)?$" class="form-control" id="longitude-input"
										placeholder="Longitude" value="" required>
								</div>
							</div>
							<div class="form-group mb-3">
								<button class="btn btn-primary btn--red mx-auto d-flex" onclick="getLocation()"
									type="button">
							...
							<div class="form-group">
								...
								<textarea class="form-control" id="description-input" rows="3" required></textarea>
							</div>

							<div class="form-group">
								<label for="picture-input">Upload a picture</label>
								<input type="file" class="form-control-file" id="picture-input">
							</div>
							<button class="btn btn-primary btn--red" type="submit">Submit form</button>
						</form>
					</div>
				</div>
